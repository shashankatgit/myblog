...
@section('content')
    ...
    <br>
    <div class="container">
        <form class="form-horizontal col-sm-12" action="{{route('admin.postEditPost')}}" method="POST">
            ...
            <div class="form-group row col-sm-12">
                ...
                <input class="custom-input form-control" type="text" placeholder="Author of the post" id="author"
                       name="author" required value="{{$post->authorName}}">
            </div>
            <div class="form-group row col-sm-12">
                <label for="content">Content</label>
                <textarea class="col-sm-12" placeholder="Content of the post" id="content" name="content" rows="50"                          >
                    {!! $post->content !!}
                </textarea>
            </div>
            <div class="form-group row col-sm-12">
